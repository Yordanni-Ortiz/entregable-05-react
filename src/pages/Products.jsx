  ...
  return (
    <div>
      ...
      <div className='filter'>
        <FormGroup >
	    <Form.Label htmlFor="name">By Name</Form.Label><Form.Control
	        id="name"
	        type="text"
          className="butt"
	        value={input}
        ...
        <FormGroup>
	    <Form.Label htmlFor="min">By Price</Form.Label><Form.Control
	        id="min"
	        type="number"
          className="butt"
	        value={range.min}
          ...
          <Col key={producItem.id}>
            <Card className="container__cards">
              ...
              <Card.Body className="card__body">
                  ...
                  <div className="bu">
                  <Button variant="secondary"  as={ Link } to={`/product/${producItem.id}`}>Details</Button>
                  <Button variant="warning"  onClick={() => handleAddCart(producItem) }><Cart4/></Button> 
                  </div>
